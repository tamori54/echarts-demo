...
require(
    ...
    function (ec) {
        ...
        var myChart1 = ec.init(document.getElementById('pie-chart')); 
...
require(
    ...
    function (ec) {
        // Initialize after dom ready
        var myChart2 = ec.init(document.getElementById('bar-chart')); 
...
require(
    ...
    function (ec) {
        // Initialize after dom ready
        var myChart3 = ec.init(document.getElementById('line-chart')); 
